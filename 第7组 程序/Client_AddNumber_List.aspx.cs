...
public partial class Client_AddNumber_List : WebPage
{
    ...
    {
        AddNumberMgr mgr = new AddNumberMgr();
        DataTable dtNumber = mgr.GetAddNumberList("",this.eUserID, "", "");
    ...
    protected void dgList_DeleteCommand(object source, DataGridCommandEventArgs e)
    {
        ...
        sMgr.DelAddNumber(e.Item.Cells[0].Text);
        this.initForm();
    }
    ...
    {
        Response.Redirect("Person_AddNumber_Edit.aspx");
    }
    #endregion
