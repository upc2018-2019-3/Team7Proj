<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Client_List.aspx.cs" Inherits="Client_List" %>
							...
							<tr>
								<td height="30" bgcolor="#ffffff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td align="right">
                                                登录名称<asp:TextBox
                                                    ID="txtClientID" runat="server" Columns="8" CssClass="box"></asp:TextBox>真实姓名<asp:TextBox ID="txtClientName" runat="server" Columns="8"
													...
													<tr>
														<td valign="top">
															<asp:DataGrid id="dgList" runat="server" BorderColor="#999999" BorderStyle="None" BorderWidth="1px"
																...
																<Columns>
																	<asp:BoundColumn DataField="ClientID" HeaderText="登录名称">
																		<HeaderStyle HorizontalAlign="Center" Width="15%"></HeaderStyle>
																	</asp:BoundColumn>
																	<asp:BoundColumn DataField="ClientName" HeaderText="真实姓名">
																	...
																	<asp:TemplateColumn HeaderText="编辑">
																		...
																		<ItemTemplate>
																			<asp:HyperLink id="hyEdit" runat="server" NavigateUrl='<%# "Client_Edit.aspx?ClientID=" + DataBinder.Eval(Container.DataItem,"ClientID") %>'>编辑</asp:HyperLink>
																		</ItemTemplate>
																	</asp:TemplateColumn>
