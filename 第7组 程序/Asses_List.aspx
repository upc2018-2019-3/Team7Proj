							...
							<tr>
								<td height="30" bgcolor="#ffffff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td align="right">
                                                学号<asp:TextBox
                                                    ID="txtAssesID" runat="server" Columns="8" CssClass="box"></asp:TextBox>姓名<asp:TextBox ID="txtAssesName" runat="server" Columns="8"
														...
														<td valign="top">
															<asp:DataGrid id="dgList" runat="server" BorderColor="#999999" BorderStyle="None" BorderWidth="1px"
																...
																<Columns>
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="智育分">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="德育分">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="体育分">
                                                                        <ItemTemplate>
