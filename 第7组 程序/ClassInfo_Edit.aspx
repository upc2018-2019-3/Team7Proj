<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClassInfo_Edit.aspx.cs" Inherits="ClassInfo_Edit" %>
								...
								<td height="30" bgcolor="#ffffff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td align="right" style="height: 23px">
                                                学生班级名称<asp:TextBox ID="txtClassInfoName" runat="server"></asp:TextBox>&nbsp;<asp:Button id="btnNew" runat="server" CssClass="box" Text="新 增" onclick="btnNew_Click"></asp:Button>
											</td>
										</tr>
									</table>
								</td>
													...
													<tr>
														<td valign="top">
															<asp:DataGrid id="dgList" runat="server" BorderColor="#999999" BorderStyle="None" BorderWidth="1px"
																...
																<Columns>
                                                                    <asp:BoundColumn DataField="ClassInfoID" Visible="False" ReadOnly="True"></asp:BoundColumn>
																	<asp:BoundColumn DataField="ClassInfoName" HeaderText="学生班级名称">
