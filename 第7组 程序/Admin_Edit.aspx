										...
										<TBODY>
											...
											<TR>
												<TD id="submenu1"><DIV class="sec_menu" style="WIDTH: 100%">
															...
															<TBODY>
                                                                <tr>
                                                                    <td align="right" width="15%">
                                                                        管理员编号</td>
                                                                    <td width="35%">
                                                                        <asp:TextBox ID="txtAdminID" runat="server" CssClass="box" MaxLength="50" Width="90%"></asp:TextBox></td>
                                                                    <td align="right" width="15%">
                                                                        </td>
																...
																<TR>
																	<TD width="15%" align="right">
                                                                        真实姓名</TD>
																	<TD width="35%">
                                                                        <asp:TextBox ID="txtAdminName" runat="server" CssClass="box" MaxLength="50" Width="90%"></asp:TextBox></TD>
																	<TD width="15%" align="right">
                                                                        登录密码</TD>
													...
													<DIV style="WIDTH: 100%">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtAdminID"
                                                            Display="None" ErrorMessage="管理员编号不能为空"></asp:RequiredFieldValidator>
